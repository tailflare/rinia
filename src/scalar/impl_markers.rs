...
common::_impl_marker_trait!(
    Scalar,
    [usize, isize, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128, f32, f64,]
);

// Implement marker traits for all signed scalar types.
common::_impl_marker_trait!(Signed, [isize, i8, i16, i32, i64, i128, f32, f64,]);

// Implement marker traits for all unsigned scalar types.
common::_impl_marker_trait!(Unsigned, [usize, u8, u16, u32, u64, u128,]);

// Implement marker traits for all floating-point scalar types.
common::_impl_marker_trait!(Float, [f32, f64,]);

// Implement marker traits for all integer scalar types.
common::_impl_marker_trait!(Int, [usize, isize, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128,]);

// Implement marker traits for all signed integer scalar types.
common::_impl_marker_trait!(SignedInt, [isize, i8, i16, i32, i64, i128,]);

// Implement marker traits for all unsigned integer scalar types.
common::_impl_marker_trait!(UnsignedInt, [usize, u8, u16, u32, u64, u128,]);
...
common::_impl_marker_trait!(SignedOps, [isize, i8, i16, i32, i64, i128, f32, f64,]);

// Implement marker trait for floating-point math for all floating-point scalar types.
common::_impl_marker_trait!(FloatOps, [f32, f64]);
...
common::_impl_marker_trait!(SignedIntOps, [isize, i8, i16, i32, i64, i128]);
...
common::_impl_marker_trait!(SaturatingIntNegOps, [isize, i8, i16, i32, i64, i128]);

// Implement marker trait for wrapping negation for all signed integer scalar types.
common::_impl_marker_trait!(WrappingIntNegOps, [isize, i8, i16, i32, i64, i128]);

// Implement marker trait for checked negation for all signed integer scalar types.
common::_impl_marker_trait!(CheckedIntNegOps, [isize, i8, i16, i32, i64, i128]);

// Implement Rounding marker for floating scalar types.
common::_impl_marker_trait!(Rounding, [f32, f64]);
