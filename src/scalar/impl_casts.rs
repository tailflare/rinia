...
scalar::_impl_scalar_infallible_casts!(
    usize => [usize],
    isize => [isize],
...
scalar::_impl_scalar_lossy_casts!(
    usize => [
        usize, isize,
        u8, u16, u32, u64, u128,
        i8, i16, i32, i64, i128,
...
scalar::_impl_scalar_saturating_cast_unsigned_to_unsigned_wide!(
    u8 => [u8, u16, u32, u64, u128],
    u16 => [u16, u32, u64, u128],
    u32 => [u32, u64, u128],
    u64 => [u64, u128],
...
// Impl SaturatingCast for unsigned int to unsigned int where dst width < src width
scalar::_impl_scalar_saturating_cast_unsigned_to_unsigned_narrow!(
    u16 => [u8],
    u32 => [u8, u16],
    u64 => [u8, u16, u32],
    u128 => [u8, u16, u32, u64]
...
scalar::_impl_scalar_saturating_cast_signed_to_signed_narrow!(
    i8 => [i8],
    i16 => [i8, i16],
    i32 => [i8, i16, i32],
    i64 => [i8, i16, i32, i64],
...
// Impl SaturatingCast for signed int to signed int where dst width > src width
scalar::_impl_scalar_saturating_cast_signed_to_signed_wide!(
    i8 => [i16, i32, i64, i128],
    i16 => [i32, i64, i128],
    i32 => [i64, i128],
    i64 => [i128]
...
scalar::_impl_scalar_saturating_cast_unsigned_to_signed!(
...
scalar::_impl_scalar_saturating_cast_signed_to_unsigned_wide!(
...
// Impl SaturatingCast for signed int to unsigned int where dst width < src width
scalar::_impl_scalar_saturating_cast_signed_to_unsigned_narrow!(
    i16 => [u8],
    i32 => [u8, u16],
    i64 => [u8, u16, u32],
    i128 => [u8, u16, u32, u64]
...
scalar::_impl_scalar_saturating_cast_int_to_float!(
    usize => [f32, f64],
    isize => [f32, f64],
    u8 => [f32, f64],
    u16 => [f32, f64],
...
scalar::_impl_scalar_saturating_cast_float_to_int!(
...
scalar::_impl_scalar_signed_cast!(
    usize => isize,
    isize => isize,
    u8 => i8,
    u16 => i16,
...
scalar::_impl_scalar_try_cast_int_to_int!(
...
scalar::_impl_scalar_try_cast_int_to_float!(
    usize => [f32, f64],
    isize => [f32, f64],
    u8 => [f32, f64],
    u16 => [f32, f64],
...
scalar::_impl_scalar_try_cast_float_to_int!(
    f32 => [usize, isize, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128],
    f64 => [usize, isize, u8, u16, u32, u64, u128, i8, i16, i32, i64, i128]
);

// Impl TryCast for float to float
scalar::_impl_scalar_try_cast_float_to_float!(
    f32 => [f32, f64],
    f64 => [f32, f64]
);
