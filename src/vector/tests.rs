...
fn approx_eq_abs_surface() {
    ...
    assert_approx_eq_abs!(a, b);
    assert_approx_ne_abs!(a, c);

    assert_approx_eq_abs_tol!(a, b, 1e-6);
    assert_approx_ne_abs_tol!(a, c, 1e-6);
...
fn approx_eq_rel_surface() {
    ...
    assert_approx_eq_rel!(a, b);
    assert_approx_ne_rel!(a, c);

    assert_approx_eq_rel_tol!(a, b, 1e-4);
    assert_approx_ne_rel_tol!(a, c, 1e-4);
...
fn length_and_normalize_surface() {
    ...
    assert_approx_eq_abs_tol!(v.length_squared(), 25.0, 1e-6);
    assert_approx_eq_abs_tol!(<Vector<f32, 2> as LengthSquared>::length_squared(v), 25.0, 1e-6);

    assert_approx_eq_abs_tol!(v.length(), 5.0, 1e-6);
    assert_approx_eq_abs_tol!(<Vector<f32, 2> as Length>::length(v), 5.0, 1e-6);
    ...
    assert_approx_eq_abs_tol!(n, Vector::from_array([0.6, 0.8]), 1e-6);
    assert_approx_eq_abs_tol!(nt, Vector::from_array([0.6, 0.8]), 1e-6);
...
fn lerp_surface() {
    ...
    assert_approx_eq_abs_tol!(inherent, expected, 1e-6);
    assert_approx_eq_abs_tol!(trait_path, expected, 1e-6);
    assert_approx_eq_abs_tol!(inherent, trait_path, 1e-6);
}
...
fn minmax_surface() {
    ...
    assert_approx_eq_abs_tol!(min_f, Vector::<f32, 2>::from_array([3.3, 2.2]), 1e-6);
    assert_approx_eq_abs_tol!(max_f, Vector::<f32, 2>::from_array([5.5, 7.7]), 1e-6);
}
...
fn abs_surface() {
    ...
    let abs_f = nf.abs();
    assert_approx_eq_abs_tol!(abs_f, Vector::<f32, 2>::from_array([1.5, 2.5]), 1e-6);
}
...
fn cross_product_surface() {
    ...
    let cross = a.cross(b);
    assert_approx_eq_abs_tol!(cross, Vec3::new(-3.0, 6.0, -3.0), 1e-6);
    ...
    assert_approx_eq_abs_tol!(x.cross(y), z, 1e-6);
    assert_approx_eq_abs_tol!(y.cross(z), x, 1e-6);
    assert_approx_eq_abs_tol!(z.cross(x), y, 1e-6);

    // Anti-commutativity: a × b = -(b × a)
    let result1 = a.cross(b);
    let result2 = b.cross(a);
    assert_approx_eq_abs_tol!(result1, -result2, 1e-6);
}
