...
fn inverse_surface() {
    ...
    assert_approx_eq_abs!(inverse, trait_inverse);
    assert_approx_eq_abs!(inverse, expected);
    assert_approx_eq_abs!(trait_inverse, expected);
}
...
fn compose_surface() {
    ...
    assert_approx_eq_abs!(composed_inherent, composed_op);
    assert_approx_eq_abs!(composed_inherent, expected);
}
